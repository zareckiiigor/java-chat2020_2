...
public class Controller implements Initializable {
    ...
    public void setAuthenticated(boolean authenticated) {
        ...
        changeNick.setManaged(authenticated);
                    ...
                    while (true) {
                        ...
                        if (str.startsWith("/")) {
                            ...
                            if (str.startsWith("/changenickok ")) {
                                nick = str.split(" ")[1];
                                textArea.appendText("Логин изменен на " + nick + "\n");
                                setTitle(nick);
                            }
    ...
    private Stage createChangeNickWindow() {
        ...
        try {
            ...
            ChangeNick changeNick = fxmlLoader.getController();
            changeNick.controller = this;
    ...
    public void tryChangeNick(String newNickname) {
        String msg = String.format("/changenick %s", newNickname);
    ...
    public void changeNickWindow(ActionEvent actionEvent) {
//        changeNick.setNewNickField("");
